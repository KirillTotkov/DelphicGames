...
namespace DelphicGames.Data.Migrations
{
    ...
    [Migration("20241121064032_add-unique-nomination-name")]
    partial class adduniquenominationname
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DelphicGames.Data.Models.Camera", b =>
                {
                    ...
                    b.HasIndex("Url")
                        .IsUnique()
                        .HasDatabaseName("ix_cameras_url");
            ...
            modelBuilder.Entity("DelphicGames.Data.Models.Nomination", b =>
                {
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("ix_nominations_name");
            ...
            modelBuilder.Entity("DelphicGames.Data.Models.Camera", b =>
                {
                    ...
                    b.HasOne("DelphicGames.Data.Models.User", "User")
                        .WithMany("Cameras")
